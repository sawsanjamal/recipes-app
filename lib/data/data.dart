...
const dummyMeals = [
  ...
  Meal(
    ...
    title: 'Lebanese-Style Red Lentil Soup',
    affordability: Affordability.affordable,
    complexity: Complexity.simple,
    imageUrl:
        'https://www.allrecipes.com/thmb/U1VDMvViUUko4iOHL4l8Ozdu--s=/750x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/291193-lebanese-style-red-lentil-soup-cookinmama-4x3-1-1966e7bfdb6f4cb5a5ba5f428313bdf9.jpg',
    duration: 240,
    ingredients: [
  ...
  Meal(
    ...
    complexity: Complexity.hard,
    imageUrl:
        'https://www.allrecipes.com/thmb/C9d4U_1Ix-LlrYdLSZnHrBPD9Fs=/0x512/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/AR-244929_Lemon-Meringue-Cheesecake-DDMFS-4x3-df1a689ad3394c42a44fc4d649a24ef2.jpg',
    duration: 600,
    ingredients: [
